...
To use the [create-gfm-fixtures](https://github.com/wooorm/create-gfm-fixtures) you need a **personal GitHub access token**, because the tool will create gists on GitHub, insert the markdown and then read the converted HTML from GitHub, to finally compare the result with the HTML that got generated by this plugin.
