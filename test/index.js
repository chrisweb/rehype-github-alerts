...
// Note: code in here heavily inspired by:
// https://github.com/rehypejs/rehype-github/blob/main/packages/emoji/test/index.js
const base = new URL('fixtures/', import.meta.url)
const legacyAlertsBase = new URL('legacy_fixtures/', import.meta.url)

await createGfmFixtures(base)

const files = await fs.readdir(base)
const legacyFiles = await fs.readdir(legacyAlertsBase)

runTests(files, base)
runTests(legacyFiles, legacyAlertsBase)

function runTests(files, base) {
    ...
    while (++index < files.length) {
        ...
        test('rehypeGithubAlerts ' + name, async () => {
